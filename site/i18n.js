...
export const LOCALES = {
  en: {
    ...
    "hero.hint": "Tap the screen to step through, or just scroll.",
    ...
    "strip.1.title": "Consoles", "strip.1.body": "Tap any tile and it opens across the whole strip. Every processor core, what's filling memory, your network and its addresses, the next 24 hours of weather, today on a timeline. Quit a runaway app right from the list.",
    "strip.2.title": "Deck", "strip.2.body": "A launcher you set up with your thumb. Buttons open apps and sites, fire hotkeys, run shell commands or call a webhook, and you can chain several into one tap.",
    "strip.3.title": "Clock", "strip.3.body": "World clocks, a focus timer, and a bar that shows how far through the day you are.",
    "strip.4.title": "Assistant", "strip.4.body": "Ask by voice or keyboard. It opens apps, checks on the system, looks things up and sets reminders, and it asks before doing anything risky. Works with any OpenAI-compatible endpoint, including models running on your own Mac.",
    "strip.5.title": "Control centre", "strip.5.body": "Wi-Fi, Bluetooth, dark mode, brightness, sound output and playback, one swipe down from the top-right corner.",
    "strip.6.title": "Boost", "strip.6.body": "Shows which background apps are eating memory and quits the ones you pick. It doesn't pretend to clean your RAM.",
    ...
    "tiles.0.idx": "Instruments", "tiles.0.title": "Gauges built from ticks", "tiles.0.body": "Forty-eight ticks across 270 degrees, drawn by the GPU. With every gauge live, the app uses under one percent of a core and less than 100 MB of memory.",
  ...
  "zh-Hans": {
    ...
    "hero.hint": "点一下屏幕，一步步往下看；直接滚动也行。",
    "strip.0.title": "仪表盘", "strip.0.body": "处理器、内存、网络、温度、天气、日程、待办，还有正在播放的歌。十八种小组件随你摆放，上下两行排开，隔着桌子也看得清。",
    "strip.1.title": "详情面板", "strip.1.body": "点一下小组件，它就铺满整条屏幕：每个处理器核心的负载、内存都被谁占了、网络和各个地址、未来 24 小时的天气、排在时间轴上的今日日程。哪个应用失控了，在列表里直接退出。",
    "strip.2.title": "快捷面板", "strip.2.body": "用拇指就能搭好的启动器。按钮可以打开应用和网站、触发快捷键、运行 Shell 命令或调用 Webhook，还能把几个动作串成一次点按。",
    "strip.3.title": "时钟", "strip.3.body": "世界时钟、专注计时器，还有一条进度条，告诉你今天已经过去了多少。",
    "strip.4.title": "助手", "strip.4.body": "说话或打字都行。它能打开应用、查看系统状态、上网查资料、设置提醒，遇到有风险的操作会先征求你的同意。支持任何兼容 OpenAI 的接口，包括跑在你自己 Mac 上的本地模型。",
    "strip.5.title": "控制中心", "strip.5.body": "Wi-Fi、蓝牙、深色模式、亮度、声音输出和播放控制，从右上角向下一划就到。",
    "strip.6.title": "加速", "strip.6.body": "看看哪些后台应用最占内存，选中就能退出。不玩“清理内存”那种噱头。",
    ...
    "tiles.0.idx": "仪表", "tiles.0.title": "用刻度画出来的仪表", "tiles.0.body": "270 度的弧上排着 48 格刻度，全部交给 GPU 绘制。所有仪表同时运行，占用也不到一个核心的 1%，内存不到 100 MB。",
  ...
  "zh-Hant": {
    ...
    "hero.hint": "點一下螢幕，一步步往下看；直接捲動也行。",
    "strip.0.title": "儀表板", "strip.0.body": "處理器、記憶體、網路、溫度、天氣、行事曆、待辦事項，還有正在播放的歌。十八種小工具隨你排列，上下兩列，隔著桌子也看得清楚。",
    "strip.1.title": "詳細面板", "strip.1.body": "點一下小工具，它就鋪滿整條螢幕：每個處理器核心的負載、記憶體被誰佔了、網路和各個位址、未來 24 小時的天氣、排在時間軸上的今日行程。哪個 App 失控了，在列表裡直接結束。",
    "strip.2.title": "快捷面板", "strip.2.body": "用拇指就能搭好的啟動器。按鈕可以打開 App 和網站、觸發快速鍵、執行 Shell 指令或呼叫 Webhook，還能把幾個動作串成一次點按。",
    "strip.3.title": "時鐘", "strip.3.body": "世界時鐘、專注計時器，還有一條進度列，告訴你今天已經過了多少。",
    "strip.4.title": "助理", "strip.4.body": "用說的或用打的都行。它能打開 App、查看系統狀態、上網查資料、設定提醒事項，遇到有風險的操作會先問過你。支援任何相容 OpenAI 的端點，包括在你自己 Mac 上執行的本機模型。",
    "strip.5.title": "控制中心", "strip.5.body": "Wi-Fi、藍牙、深色模式、亮度、聲音輸出和播放控制，從右上角往下一滑就到。",
    "strip.6.title": "加速", "strip.6.body": "看看哪些背景 App 最吃記憶體，選起來就能結束。不玩「清理記憶體」那種噱頭。",
    ...
    "tiles.0.idx": "儀表", "tiles.0.title": "用刻度畫出來的儀表", "tiles.0.body": "270 度的弧上排著 48 格刻度，全部交給 GPU 繪製。所有儀表同時運作，用量也不到一個核心的 1%，記憶體不到 100 MB。",
  ...
  ja: {
    ...
    "hero.hint": "画面をタップすると次へ進みます。スクロールでも進めます。",
    "strip.0.title": "ダッシュボード", "strip.0.body": "CPU、メモリ、ネットワーク、温度、天気、予定、タスク、そして再生中の曲。18 種類のタイルを 2 段のボードに自由に並べられ、机の向こうからでも読み取れます。",
    "strip.1.title": "コンソール", "strip.1.body": "タイルをタップすると、画面いっぱいに詳細が開きます。コアごとの負荷、メモリの内訳、ネットワークとアドレス、24 時間先までの天気、タイムラインで見る今日の予定。暴走しているアプリは、その場で終了できます。",
    "strip.2.title": "デッキ", "strip.2.body": "親指ひとつで組めるランチャー。ボタンからアプリやサイトを開いたり、ショートカットキーを送ったり、シェルコマンドや Webhook を実行できます。複数の操作をワンタップにまとめることも。",
    "strip.3.title": "時計", "strip.3.body": "世界時計、集中タイマー、そして今日がどこまで進んだかを示すバー。",
    "strip.4.title": "アシスタント", "strip.4.body": "声でもキーボードでも。アプリを開き、システムの状態を確認し、調べものをして、リマインダーも設定します。リスクのある操作は必ず先に確認します。OpenAI 互換のエンドポイントならどれでも使え、手元の Mac で動くローカルモデルにも対応します。",
    "strip.5.title": "コントロールセンター", "strip.5.body": "Wi-Fi、Bluetooth、ダークモード、明るさ、音声出力、再生コントロール。右上から下へスワイプするだけです。",
    "strip.6.title": "ブースト", "strip.6.body": "メモリを多く使っているバックグラウンドのアプリを表示し、選んだものだけを終了します。「メモリ解放」のようなごまかしはしません。",
    ...
    "tiles.0.idx": "メーター", "tiles.0.title": "目盛りで描くゲージ", "tiles.0.body": "270 度の弧に 48 本の目盛り。描画は GPU に任せているので、すべてのゲージを動かしていても CPU 使用率は 1 コアの 1% 未満、メモリは 100 MB 未満です。",
