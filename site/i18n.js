...
export const LOCALES = {
  en: {
    ...
    "tiles.0.idx": "Instruments", "tiles.0.title": "Gauges built from ticks", "tiles.0.body": "Forty-eight ticks across 270 degrees, drawn by the GPU. With every gauge live, the app uses under one percent of a core and about 60 MB of memory.",
  ...
  "zh-Hans": {
    ...
    "tiles.0.idx": "仪表", "tiles.0.title": "用刻度画出来的仪表", "tiles.0.body": "270 度的弧上排着 48 格刻度，全部交给 GPU 绘制。所有仪表同时运行，占用也不到一个核心的 1%，内存约 60 MB。",
  ...
  "zh-Hant": {
    ...
    "tiles.0.idx": "儀表", "tiles.0.title": "用刻度畫出來的儀表", "tiles.0.body": "270 度的弧上排著 48 格刻度，全部交給 GPU 繪製。所有儀表同時運作，用量也不到一個核心的 1%，記憶體約 60 MB。",
  ...
  ja: {
    ...
    "tiles.0.idx": "メーター", "tiles.0.title": "目盛りで描くゲージ", "tiles.0.body": "270 度の弧に 48 本の目盛り。描画は GPU に任せているので、すべてのゲージを動かしていても CPU 使用率は 1 コアの 1% 未満、メモリは約 60 MB です。",
