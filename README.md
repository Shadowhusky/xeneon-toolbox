...
- **Light on the Mac** — built to sit there all day: the full dashboard runs
  in 60–90 MB of memory at under 1 % of one core, the ambient clock in about
  30 MB at a fraction of that. Gauges are drawn by the GPU, sampling slows down when the
